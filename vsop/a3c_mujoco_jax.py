...
def parse_args():
    ...
    parser.add_argument(
        ...
        nargs="?",
        const=True,
        help="Toggles advantages clipping",
    )
    parser.add_argument(
        "--ent-coef",
        type=float,
...
def main():
    ...
    job_dir = Path(args.job_dir) / f"{args.env_id}" / "a3c"
...
def make_train(config, layernorm=False):
    config["NUM_UPDATES"] = (
