...
from rmpg_procgen import run_experiment
...
search_space = {
    ...
    "gae_lambda": tune.quniform(0.7, 1.0, 0.001),
...
job_dir = Path().resolve() / Path(f"output/tune_rmpg/procgen/")
job_dir.mkdir(parents=True, exist_ok=True)

tuner = tune.Tuner(
    tune.with_resources(tune.with_parameters(func), resources={"CPU": 2.0, "GPU": 0.5}),
